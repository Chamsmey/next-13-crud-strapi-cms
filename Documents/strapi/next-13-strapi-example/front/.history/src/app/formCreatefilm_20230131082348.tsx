...
const FormCreateFilmCom = () => {
  ...
  const handleSumit = async(e:any)=>{
    ...
    return ( 
        <form onSubmit={handleSumit}  className={`mx-auto top-[50%] left-[50%] transition translate-x-[-50%] translate-y-[] fixed  z-[100]  rounded md:w-1/4 border p-2 bg-white`} method="POST">
        <div>
