    ...
    <section>
      <div className="mx-auto">
        <div className="w-1/3  mx-auto flex justify-end">
          <button onClick={handleOpenForm}  className="bg-blue-500 rounded px-2 py-1 text-white">
            Create post
          </button>
        </div>
      </div>
      <section
      id="form-create"
        className={`fixed bg-black/50 w-full h-[100vh] z-[2000] top-0 left-0 ${isShow? 'block': 'hidden'}`}
        >
        <form
