...
const FormCreateFilmCom = ({isShow}:{isShow:boolean}) => {
  ...
  const handleSumit = async(e:any)=>{
    ...
    return ( 
        <form onSubmit={handleSumit} id={}  className={`top-[50%] left-[50%] transition translate-x-[-50%] translate-y-[-90%] fixed  z-[100]  rounded md:w-1/4 border p-2 bg-white`} method="POST">
        <div>
