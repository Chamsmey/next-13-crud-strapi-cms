  ...
  useEffect(() =>{
    ...
    return ( 
      ...
      <section>
        ...
        <section id="form-create" className="fixed bg-black/50 w-full h-[100vh] z-[2000] top-0 left-0">


        <form onSubmit={handleSumit}  className={`top-[50%] left-[50%] transition translate-x-[-50%] translate-y-[-90%] fixed  z-[100]  rounded md:w-1/4 border p-2 bg-white`} method="POST">
        <div>
