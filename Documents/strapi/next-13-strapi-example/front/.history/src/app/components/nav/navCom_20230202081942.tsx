...
const NavCom = () => {
  ...
  return (
    <header className="lg:max-w-[1400px] md:max-w-[1200px] w-full  mx-auto bg-black/50 backdrop-blur-0 sticky top-0  z-10">
        ...
        <div className="px-2 flex text-white items-center">
          ...
          {!user ? (
            ...
            <button
              ...
              className="p-2 rounded transition duration-200 ease-in-out hover:bg-white/30 hover:cursor-pointer"
            >
              Sign out
            </button>
          )}
          ...
          {user && <h1  className="hover:cursor-pointer w-10 h-10 flex justify-center items-center bg-blue-500 rounded-full overflow-hidden">
            <span>
            {acronymName}
            </span>
            </h1>}
